                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <th class="px-4 py-3">id người dùng</th>
                                ...
                                <th class="px-4 py-3">Chỉnh sửa người dùng</th>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $rc['phone'] ?></td>
                                    <td><?= $rc['address'] ?></td>
                                    <td><a href="/canhan?id=<?= $rc['id_user'] ?>">Chỉnh sửa</a></td>
                                    <td>
                                        <?php
                                        if ($rc['block'] == 0) {
                                            echo "Bình thường";
                                    ...
                                    <td><a href="/block?id=<?= $rc['id_user'] ?>">Block luôn</a></td>
                                    <td><a href="/unblock?id=<?= $rc['id_user'] ?>">Bỏ block</a></td>
                                </tr>
                            <?php
                            }
                            ?>
